            ...
            <div class="form_login">
              ...
              <v-sheet class="bg-deep-purple pa-12" rounded>
                <v-card class="card mx-auto px-6 py-8" flat max-width="400">
                  <v-form novalidate v-model="form" @submit.prevent="onSubmit">
                    <v-text-field
                      v-model="username"
                      :readonly="loading"
                      :rules="[required]"
...
export default {
  ...
  methods: {
    onSubmit() {
      ...
      this.$axios
        .post("http://localhost/PJBL2023/api_pjbl/public/login", login) // Ubah sesuai dengan alamat dan port server lokal Anda
        .then((response) => {
